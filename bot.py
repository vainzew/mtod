...
async def main():
    ...
    worker = args.worker
    banner = f"""
{blue} ___  _ _  ___  ___   ___  ___  ___   _  ___  ___  ___     {green} Maj*r Auto Claim
{blue}| . \| | ||_ _|/ __> | . \| . \| . | | || __>|  _>|_ _|    {white} Author      : {blue} Alfansyah
{blue}| | ||   | | | \__ \ |  _/|   /| | |_| || _> | <__ | |     {white} Telegram    : {blue} t.me/rynalfan
{blue}|___/|_|_| |_| <___/ |_|  |_\_\`___'\__/|___>`___/ |_|     {green} STAY AWARE AND KEEP LEARNING
    """
